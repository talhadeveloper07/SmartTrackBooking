...
<head>
        ...
        @php
            $favicon = $business->dashboardSetting?->favicon ?? null;
        @endphp
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        ...
        <style>
:root{
    --primary: {{ $ds->primary_color ?? '#0d6efd' }};
    --bs-link-color: {{ $ds->primary_color ?? '#0d6efd' }};
    --primary-hover: {{ $ds->primary_color ?? '#0d6efd' }};
    --rgba-primary-5: {{ $ds->primary_color ?? '#0d6efd'  }};
    --secondary: {{ $ds->secondary_color ?? '#6c757d' }};
    --sidebar-bg: {{ $ds->sidebar_bg ?? '#0f172a' }};
    --sidebar-text: {{ $ds->sidebar_text ?? '#ffffff' }};
    --topbar-bg: {{ $ds->topbar_bg ?? '#ffffff' }};
    --topbar-text: {{ $ds->topbar_text ?? '#0f172a' }};
}
</style>
    </head>
    <body>
